...
This_Drone.bind(('192.168.3.183',8100))
...
def GPS2NED_conversion(inp_GPS1,inp_GPS2):
	...
	# The output of this function is the relative position of the other drone to this drone
...
def px4_com_DRN2():
	...
	while not rospy.is_shutdown():
		...
		msg = PX4.recv_match(type='GLOBAL_POSITION_INT',blocking=False)
		if not msg:
		...
		Results_File_DRN2.write("%.9f %.6f %.6f %.6f %.6f %.6f %.6f\r\n" % (rospy.get_time(),
